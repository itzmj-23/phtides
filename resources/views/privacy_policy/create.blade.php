    ...
    <div class="container mt-5 mb-3">
        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <div class="mt-5">
                    <form id="location_form" action="{{ route('privacyPolicy.store') }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <div class="input-group">
                                    <input id="title" name="title" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Enter the title of the Privacy Policy">
                                    @error('title')
...
{{--                                    <span class="label-text-alt">(optional)</span>--}}
                            ...
                            <div class="col text-left">
                                <textarea class="form-control @error('policy') is-invalid @enderror" name="policy" id="policy" cols="30" rows="20" placeholder="<h1>Privacy Policy of National Mapping and Resource Information Authority (NAMRIA)</h1>">{{ old('remarks') }}</textarea>
                                @error('policy')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10 col-md-6 col-lg-4">
                                <input class="form-control" type="text" name="added_by" value="{{ auth()->user()->email }}" readonly>
                            </div>
                        </div>
